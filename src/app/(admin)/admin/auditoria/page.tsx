...
const CONFIG_TIPOS: Partial<Record<TipoAcao, ConfigTipo>> = {
  ...
  remover_simulado: { rotulo: "Remover simulado", verbo: "removeu um simulado", icone: Trash2, tom: "success" },
  cancelar_simulado: { rotulo: "Cancelar simulado", verbo: "cancelou um simulado", icone: X, tom: "warning" },
